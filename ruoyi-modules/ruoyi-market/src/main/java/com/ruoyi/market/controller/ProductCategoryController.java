...
public class ProductCategoryController extends BaseController
{
     ...
     * 导出产品类别列表
     */
    @RequiresPermissions("market:category:export")
     ...
     * 获取产品类别详细信息
     */
    @RequiresPermissions("market:category:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增产品类别
     */
    @RequiresPermissions("market:category:add")
     ...
     * 修改产品类别
     */
    @RequiresPermissions("market:category:edit")
     ...
     * 删除产品类别
     */
    @RequiresPermissions("market:category:remove")
