...
import com.ruoyi.market.service.IProductPriceService;
...
public class ProductPriceController extends BaseController
{
     ...
     * 查询大盘价格数据源列表
     */
    @RequiresPermissions("market:price:list")
    @GetMapping("/list")
     ...
     * 导出大盘价格数据源列表
     */
    @RequiresPermissions("market:price:export")
     ...
     * 获取大盘价格数据源详细信息
     */
    @RequiresPermissions("market:price:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增大盘价格数据源
     */
    @RequiresPermissions("market:price:add")
     ...
     * 修改大盘价格数据源
     */
    @RequiresPermissions("market:price:edit")
     ...
     * 删除大盘价格数据源
     */
    @RequiresPermissions("market:price:remove")
