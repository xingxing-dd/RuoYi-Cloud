<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['market:financial:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['market:financial:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['market:financial:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['market:financial:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="financialList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="产品图标" align="center" prop="productIcon" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.productIcon" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="产品图标" prop="productIcon">
          <image-upload v-model="form.productIcon"/>
        </el-form-item>
...
<script>
import { listFinancial, getFinancial, delFinancial, addFinancial, updateFinancial } from "@/api/market/financial";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('market/financial/export', {
        ...this.queryParams
