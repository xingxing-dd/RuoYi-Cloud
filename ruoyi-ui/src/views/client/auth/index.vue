    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="证件号" prop="credentialNo">
          <el-input v-model="form.credentialNo" placeholder="请输入证件号" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
<script>
import { listAuth, getAuth, delAuth, addAuth, updateAuth } from "@/api/client/auth";
  ...
  methods: {
    ...
    reset() {
      this.form = {
        ...
        userId: null,
        userName: null,
        credentialFront: null,
        credentialBackground: null,
        realName: null,
        credentialNo: null,
        status: null,
        remark: null,
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('client/auth/export', {
        ...this.queryParams
